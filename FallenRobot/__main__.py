...
from FallenRobot import (ALLOW_EXCL, CERT_PATH, DONATION_LINK, LOGGER,
            ...
            if args[0].lower() == "help":
                ...
                send_help(
                    ...
                    InlineKeyboardMarkup(
                        [[InlineKeyboardButton(text="Ã— BACK Ã—", callback_data="help_back")]]
                    ),
                )
...
def shukurenai_about_callback(update, context):
    ...
    if query.data == "shukurenai_":
        query.message.edit_text(
            text="à¹ I'm *ð‘­ð‘¨ð‘µð‘»ð‘¨ð‘ºð‘»ð‘°ð‘ª*, a powerful group management bot built to help you manage your group easily."
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                 ...
                 [
                    InlineKeyboardButton(text="Try inline!â€‹â€‹", switch_inline_query_current_chat=""), 
                 ],
                 [
                    InlineKeyboardButton(text="GoðŸ™†Back", callback_data="shukurenai_back"),
                 ]
                ]
            ),
        )
        ...
        query.message.edit_text(
            ...
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton(text="GoðŸ’Back", callback_data="shukurenai_")]]
            ),
        )
        ...
        query.message.edit_text(
            text="*à¹ Fantastic support chats*"
            "\nJoin My Support Group/Channel for see or report a problem on ð‘­ð’‚ð’ð’•ð’‚ð’”ð’•ð’Šð’„ ð’”ð’–ð’‘ð’‘ð’ð’“ð’•.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
                    InlineKeyboardButton(text="Support", url="https://t.me/Samurai_Botsupport"),
                    InlineKeyboardButton(text="Updates", url="https://t.me/Samurai_Bot_Update"),
                 ],
                 [
                    InlineKeyboardButton(text="GoðŸ™…Back", callback_data="shukurenai_"),
        ...
        query.message.edit_text(
            text=f"à¹ Donate for FantasticBot",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
...
def main():
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(f"@{SUPPORT_CHAT}", "I Am Online Again To Save Your Group From Shogun")
        except Unauthorized:
            LOGGER.warning(
