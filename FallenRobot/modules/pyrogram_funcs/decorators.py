...
from FallenRobot import DRAGONS as SUPREME_USERS,SUPPORT_CHAT
        ...
        async def wrapper(client, update):
            ...
            try:
                ...
                if len(error_message) > 4096:
                   ...
                   await pgram.send_document(SUPPORT_CHAT,out_file)
                else:
                    await pgram.send_message(SUPPORT_CHAT,error_message)
