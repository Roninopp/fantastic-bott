    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                ...
                thumb_url="https://telegra.ph/file/a45d2ff56694ee70e2f7d.jpg",
        ...
        try:
            ...
            mm = [
                InlineQueryResultArticle(
                    ...
                    thumb_url="https://telegra.ph/file/1392cac1817c44e181aa6.jpg",
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="💒 Whisper",
            description=f"@Makise_KurisuRobot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**📍Usage:**\n\n@Makise_KurisuRobot (Target Username or ID) (Your Message).\n\n**Example:**\n@Makise_KurisuRobot @username How are You"),
