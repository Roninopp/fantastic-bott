from FallenRobot import pbot as app,TOKEN as bot_token
...
async def _reverse(_,msg):
    text = await msg.reply("**⏳ Just a moment, I'm working on it...**")
    file_id = await get_file_id_from_message(msg)
    if not file_id:
        return await text.edit("**Please reply to a photo, video, or sticker to perform a reverse image search!**")
    await text.edit("**Just a moment, I'm working on it.......**")    
