...
async def reqgban(_, msg: Message):
    ...
    thumb = "https://telegra.ph/file/733d1fd730819742b208c.jpg"
    ...
    if user_id == owner_id:
        ...
        if bugs:
            await msg.reply_text(
                ...
                "<b>The gban was successfully requested to the support group @Samurai_botsupport !</b>",
...
__help__ = """
➩ /reqgban username or userid To Gban For scammers, raiders, abusers, massadders, etc. .  
"""

__mod_name__ = "ʀᴇQᴜᴇꜱᴛ-ɢʙᴀɴ"
