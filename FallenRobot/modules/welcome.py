...
def new_member(update: Update, context: CallbackContext):
    ...
    for new_mem in new_members:
        ...
        if new_mem.id == bot.id and not GabiBraunRobot.ALLOW_CHATS:
            with suppress(BadRequest):
                update.effective_message.reply_text(f"Sorry but this bot is only for some private chats. \n You can use @Gabi_Braun_Robot instead of this bot! Because the codes of both are same. \n • Powered By @EldianCommunity and Created by Mikey sano! •")
        ...
        if should_welc:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_photo(
                    OWNER_IMG, caption=f"The Founder of Eldian Arena <b>{html.escape(user.first_name)}</b> has joined this group!", reply_to_message_id=reply,
            ...
            # Welcome Devs
                ...
                update.effective_message.reply_animation(
                    DEV_IMG, caption="Be cool! A Royal person of the Eldian Arena, just joined!", reply_to_message_id=reply,
                    parse_mode=ParseMode.HTML,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Sudos
                ...
                update.effective_message.reply_animation(
                    DRAGON_IMG, caption="Watch out! A Titan just joined your group!", reply_to_message_id=reply,
                    parse_mode=ParseMode.HTML,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Support
                ...
                update.effective_message.reply_animation(
                    DEMON_IMG, caption="Huh! Someone with Survey Corp diaster, just joined!", reply_to_message_id=reply,
                    parse_mode=ParseMode.HTML,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Whitelisted
                ...
                update.effective_message.reply_photo(
                    TIGER_IMG, caption="A Eldian just joined! it's just an Eldian!", reply_to_message_id=reply,
                    parse_mode=ParseMode.HTML,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
            ...
            # Welcome Tigers
                ...
                update.effective_message.reply_photo(
                    WOLVE_IMG, caption="Kami-Sama! A Marleyan joined, But who cares!", reply_to_message_id=reply,
                    parse_mode=ParseMode.HTML,
                )
                welcome_log = (
                    f"{html.escape(chat.title)}\n"
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text(
                    "Bye-Bye!! Kami-Sama! ..", reply_to_message_id=reply,
                )
                return
            ...
            # Give the devs a special goodbye
                ...
                update.effective_message.reply_text(
                    "See you later at the Eldian Arena!",
                    reply_to_message_id=reply,
                )
                return
