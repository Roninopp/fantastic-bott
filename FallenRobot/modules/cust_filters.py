...
from FallenRobot.modules.mongo.filters_db import *
from FallenRobot.modules.pyrogram_funcs.filters_func import GetFIlterMessage,get_text_reason,SendFilterMessage
...
@pgram.on_message(filters.command("filter") & filters.group)
...
@pgram.on_message(filters.all & filters.group, group=filter_watcher)
...
@pgram.on_message(filters.command('filters') & filters.group)
...
@pgram.on_message(filters.command('stopall') & filters.group)
async def stopall(client, message):
    ...
    await message.reply(
        text=(
            f'Are you sure you want to stop **ALL** filters in {chat_title}? This action is irreversible.'
        ),
        reply_markup=KEYBOARD
    )


@pgram.on_callback_query(filters.regex("^custfilters_"))
...
@pgram.on_message(filters.command('stop') & filters.group)
@user_admin
